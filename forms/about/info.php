...
<div class="d4p-group d4p-group-import d4p-group-about">
    ...
    <div class="d4p-group-inner">
        <ul>
            <li><?php esc_html_e("On WordPress.org", "gd-security-headers"); ?>: <span><a href="https://wordpress.org/plugins/gd-security-headers/" target="_blank">wordpress.org/plugins/gd-security-headers</a></span></li>
            <li><?php esc_html_e("On Dev4Press", "gd-security-headers"); ?>: <span><a href="https://plugins.dev4press.com/gd-security-headers/" target="_blank">plugins.dev4press.com/gd-security-headers</a></span></li>
        </ul>
    </div>
</div>
