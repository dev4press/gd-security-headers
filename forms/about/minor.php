<div class="d4p-about-minor">
    ...
    <p>
        <strong><?php esc_html_e("Version", "gd-security-headers"); ?> <span>1.6</span></strong> &minus;
        Many CSP related improvements.
    </p>
    <p>
        <strong><?php esc_html_e("Version", "gd-security-headers"); ?> <span>1.5</span></strong> &minus;
    ...
    <p>
        <strong><?php esc_html_e("Version", "gd-security-headers"); ?> <span>1.2</span></strong> &minus;
