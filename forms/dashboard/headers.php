<div class="d4p-group d4p-group-dashboard-card d4p-group-dashboard-basic">
    ...
    <div class="d4p-group-stats">
        <ul class="gdsih-headers-overview">
            <li>
                <a href="admin.php?page=gd-security-headers-settings&panel=global"><strong><i class="fa fa-file-code-o fa-fw"></i> <?php esc_html_e(".HTACCESS", "gd-security-headers"); ?></strong></a>
